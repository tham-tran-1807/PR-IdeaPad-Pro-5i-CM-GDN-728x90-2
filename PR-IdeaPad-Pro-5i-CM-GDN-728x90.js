...
lib.ssMetadata = [
		{name:"PR_IdeaPad_Pro_5i_CM_GDN_728x90_atlas_1", frames: [[0,736,50,50],[0,0,728,90],[0,92,728,90],[0,184,728,90],[0,276,728,90],[0,368,728,90],[0,460,728,90],[0,552,728,90],[0,644,728,90]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["PR_IdeaPad_Pro_5i_CM_GDN_728x90_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.PRIdeaPadPro5iCMGDN728x90 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.mc_mui_ten_xoay).wait(350).to({_off:false},0).to({y:10.45},12).wait(8));
...
// library properties:
lib.properties = {
	id: 'A2FD700E33EDEE4AA0148E63130213E7',
	width: 728,
	height: 90,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/PR_IdeaPad_Pro_5i_CM_GDN_728x90_atlas_1.png", id:"PR_IdeaPad_Pro_5i_CM_GDN_728x90_atlas_1"}
	],
	preloads: []
};
...
an.compositions['A2FD700E33EDEE4AA0148E63130213E7'] = {
